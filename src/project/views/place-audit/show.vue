            ...
            <div style="display: flex;justify-content: space-around;margin-top: 30px">
                <div style="margin-left: 80px">
                    <el-descriptions :column="2">
                        ...
                        <el-descriptions-item label="包时价格">99</el-descriptions-item>
                        <el-descriptions-item label="所属用户">小徐小徐是条咸鱼</el-descriptions-item>
                        <el-descriptions-item label="包天价格">{{'199'}}</el-descriptions-item>
                        <el-descriptions-item label="主页名称">{{'我是模特'}}</el-descriptions-item>
                        <el-descriptions-item label="风格">{{'御姐'}}</el-descriptions-item>
                        <el-descriptions-item label="提交时间">{{'2022-1-18 15:00'}}</el-descriptions-item>
                    </el-descriptions>
                </div>
            </div>
        </el-card>
            ...
            <div style="margin: 50px 0">
                <div v-if="true" style="height: 30px;">
                    ...
                    <div style="margin-top: 20px">
                        ...
                        <el-button size="small" style="background-color: #ff1919;border: none">拒绝</el-button>
                    </div>
                </div>
